...
## TODOs
- [ ] Add shared billing route request parsing helpers and make checkout/portal POSTs reject malformed or unsupported bodies while GET checkout stays side-effect free.
