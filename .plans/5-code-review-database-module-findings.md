...
## TODOs
- [ ] Make recipe child-row replacement transactional.
- [ ] Add schema invariants for confidence ranges, instruction-event payloads, non-empty media, and classification locales.
